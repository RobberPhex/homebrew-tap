class AjkOpenssh < Formula
  desc "OpenBSD freely-licensed SSH connectivity tools(with krb5 support)"
  ...
  if OS.mac?
    ...
    # add gsskey support
    patch do
      url "https://raw.githubusercontent.com/RobberPhex/homebrew-tap/8d93556/Patches/openssh-7.4p1-gsskex.patch"
      sha256 "eb1f56f42a1dce51cdb4bf7e4cfd5aaf70e0476d33ee874594acd060b14ab43f"
    end
  end
