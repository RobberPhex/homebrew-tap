class AjkOpenssh < Formula
  ...
  # add gsskey support
  patch do
    url "https://raw.githubusercontent.com/RobberPhex/homebrew-tap/51f3eb6/Patches/openssh-7.6p1-gsskex.patch"
    sha256 "9b638393e1cfeb03eabaa5a44222a40fa83168edf66cce9e2400a8c32b268e24"
  end
